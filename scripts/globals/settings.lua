...
COFFER_MIN_ILLUSION_TIME = 5;  -- 30 minutes
CHEST_MAX_ILLUSION_TIME  = 10;  -- 1 hour
CHEST_MIN_ILLUSION_TIME  = 5;  -- 30 minutes
...
LANTERNS_STAY_LIT = 3000; -- time in seconds that lanterns in the Den of Rancor stay lit.
